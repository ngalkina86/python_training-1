...
testdata = [Contact(firstname ="", middlename ="", lastname ="", nickname ="", title ="", company ="",
    ...
    Contact(firstname =random_string("firstname",10), middlename =random_string("middlename",15),
            ...
            homepage =random_string("homepage",15), bday = str(random.randrange(1,30)), bmonth = str(random.randrange(1,12)),
            byear = str(random.randrange(1,2019)), aday =str(random.randrange(1,30)),
            amonth = str(random.randrange(1,12)), ayear = str(random.randrange(1,2019)), address_2 = random_string("adress_2",15),
