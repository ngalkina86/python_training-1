...
def test_add_contact(app):
        ...
        app.creat_new_contact(firstname = "dsad", middlename ="fdsf", lastname = "vcxv",nickname = "fdsff",title = "vcxv",company_name = "vcxv",address = "bvcbb",home = "bvcb",mobile = "cxzc",phone_work = "test",
...
def test_add_other_contact(app):
        app.open_home_page()
        app.login(username ='admin', password = "secret")
        app.creat_new_contact(firstname = "", middlename ="",lastname = "",nickname = "",title = "",company_name = "",address = "",home = "",mobile = "",phone_work = "",
