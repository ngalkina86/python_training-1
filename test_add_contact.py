...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.creat_new_contact(wd, firstname = "dsad", middlename ="fdsf", lastname = "vcxv",nickname = "fdsff",title = "vcxv",company_name = "vcxv",address = "bvcbb",home = "bvcb",mobile = "cxzc",phone_work = "test",
    ...
    def test_add_other_contact(self):
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username ='admin', password = "secret")
        self.creat_new_contact(wd, firstname = "", middlename ="",lastname = "",nickname = "",title = "",company_name = "",address = "",home = "",mobile = "",phone_work = "",
    ...
    def creat_new_contact(self, wd, firstname, middlename, lastname, nickname, title, company_name, address, home,
                          mobile, phone_work, fax, email, email_12, email_13, homepage, bday, bmonth, byear, aday,
                          amonth, ayear, address_2, phone_2, notes):
        # add new contact
        ...
        wd.find_element_by_name("email2").send_keys(email_12)
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys(email_13)
